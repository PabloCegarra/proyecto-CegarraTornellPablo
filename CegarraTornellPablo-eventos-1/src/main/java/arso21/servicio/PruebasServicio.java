...
public class PruebasServicio {
	public static void main(String[] args) throws Exception {
		...
		servicioEventos.getListadoEventos();
		EventoCultural evento = servicioEventos
				.getInfoEvento("https://datos.madrid.es/egob/catalogo/tipo/evento/11340884.json");
		...
		EventoCultural evento3 = servicioEventos
				.getInfoEvento("https://datos.madrid.es/egob/catalogo/tipo/evento/11322033.json");
